...
# إعدادات الاتصال
CHANNEL_ID_DAY = -2468194944
CHANNEL_INVITE_LINK_DAY = 'https://t.me/+tYDgNHmMqxRjNGIy'

CHANNEL_ID_WEEK = -2468194944
CHANNEL_INVITE_LINK_WEEK = 'https://t.me/+tYDgNHmMqxRjNGIy'

CHANNEL_ID_MONTH = -2468194944
CHANNEL_INVITE_LINK_MONTH = 'https://t.me/+tYDgNHmMqxRjNGIy'

bot_token = '7504967807:AAE2EviGcop0BntPrCpTAWM0vh8w0XzdQAo'
admin_id = 6332270659
admin = 6332270659
api_id = '29750778'  # يجب استبداله بالمعرف API الخاص بك
api_hash = '4e8fa9aef76a6f0a2c2706fa688b678e'  # يجب استبداله بالهاش API الخاص بك
phone_number = ''  # حط رقم موبايلك مع كود الدوله
cache_file = "bin_cache.json"
bot_working = True
banned_users = set()
admins = set([5817828281])#ايديك هنا بدل كلمه id
users = {}
...
def luhn_check(card_number):
    # دالة تحقق رقم البطاقة (Luhn algorithm)
    def digits_of(n):
...
def generate_expiry_date(current_year, current_month, expiry_month=None, expiry_year=None):
    # دالة لتوليد تاريخ انتهاء الصلاحية
    if expiry_month is None:
        expiry_month = random.randint(1, 12)
    if expiry_year is None:
        expiry_year = current_year + random.randint(1, 5)
    return {"month": expiry_month, "year": expiry_year}

def generate_cards(bin, count, current_year, current_month, expiry_month=None, expiry_year=None, use_backticks=False):
    cards = set()
...
def my_function(message):
    if message.chat.type == "private":
        ...
        if BL == 'FREE':
            ...
            contact_button = types.InlineKeyboardButton(text="✨ 𝗢𝗪𝗡𝗘𝗥  ✨", url="https://t.me/k7e7e")
            keyboard.add(contact_button)
            random_number = random.randint(33, 82)
            photo_url = f'https://t.me/k7e7e'
...
''', reply_markup=keyboard)
            return
        keyboard = types.InlineKeyboardMarkup()
        contact_button = types.InlineKeyboardButton(text=f"✨ JOIN✨", url="https://t.me/k7e7e")
        keyboard.add(contact_button)
        username = message.from_user.first_name
        random_number = random.randint(33, 82)
        photo_url = f'https://t.me/beow6/3'
...
def brn(ccx):
    ...
    'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiIsImtpZCI6IjIwMTgwNDI2MTYtcHJvZHVjdGlvbiIsImlzcyI6Imh0dHBzOi8vYXBpLmJyYWludHJlZWdhdGV3YXkuY29tIn0..jKEs2WaIBj8uNME7netJG0srowcpaOp72sYG5DCCL4QmtNSuzAUeGaGVze4dEUu03g1JcyCaf24fJxoTwBFmWg',
    ...
    'clientSdkMetadata': {
        'source': 'client',
        'integration': 'dropin2',
        'sessionId': '780c068a-dbd8-41d5-b956-09d68cf1b771',
    },
    ...
    'bin': '518542',
    'dfReferenceId': '1_ea430100-91ba-4f7e-992e-84e8fca36aba',
    'clientMetadata': {
        'requestedThreeDSecureVersion': '2',
        'sdkVersion': 'web/3.99.0',
        'cardinalDeviceDataCollectionTimeElapsed': 806,
        'issuerDeviceDataCollectionTimeElapsed': 9096,
...
The VIP plan allows you to use all the tools and portals in the bot without limits You can also scan cards through a file
━━━━━━━━━━━━━━━━━
...
def start(message):
	def my_function():
		...
		try:
			...
			pas ='SUFI-'+''.join(random.choices(characters, k=4))+'-'+''.join(random.choices(characters, k=4))+'-'+''.join(random.choices(characters, k=4))
			current_time = datetime.now()
...
●●●●●●●●●●●"""
            ...
            with open('Saoud_Scrap.txt', 'rb') as file:
                ...
                dev_button = telebot.types.InlineKeyboardButton(text="𝗗𝗘𝗩", url='https://t.me/k7e7e')
